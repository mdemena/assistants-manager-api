...
class AssistantController {
	static async get(id) {
		return await Assistant.findById(id).populate([{path:'game', populate:['localTeam','visitTeam']},'team']);
	}
	static async set(assistant) {
		return await Assistant.findByIdAndUpdate(assistant._id, assistant, {
			new: true,
		});
	}
